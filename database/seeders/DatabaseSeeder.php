...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        \App\Models\Setting::set('whatsapp_message_template', 'Halo Admin Berkah Mulia, saya ingin bertanya mengenai produk...');
        \App\Models\Setting::set('instagram_url', 'https://www.instagram.com');
        \App\Models\Setting::set('shopee_url', 'https://shopee.co.id');
    }
}
